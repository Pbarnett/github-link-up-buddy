...
function transformAmadeusToOffers(api: any, tripRequestId: string): TablesInsert<"flight_offers">[] {
...
// Export the transform function for testing
export { transformAmadeusToOffers };
