...
export class SupabaseErrorHandler {
  ...
  private static handleAuthError(error: AuthError): SupabaseError {
    ...
    const userFriendlyMessage =
      commonAuthErrors[error.message] || 'Authentication failed';
  ...
  private static handleFunctionsHttpError(
  ...
  private static handleFunctionsRelayError(
  ...
  private static handleFunctionsFetchError(
