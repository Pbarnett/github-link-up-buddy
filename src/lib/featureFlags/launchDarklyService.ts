...
import { , LaunchDarklyConfig, LaunchDarklyMetrics, LaunchDarklyServiceState, RetryResult, DEFAULT_LAUNCHDARKLY_CONFIG } from '../../types/launchDarkly';
  LaunchDarklyConfig,
  LaunchDarklyMetrics,
...
class LaunchDarklyService {
  ...
  private _getRawVariation<T>(flagKey: string, defaultValue: T): T {
    try {
      ...
      console.error(
        `Error in raw variation helper for flag ${flagKey}:`,
        error
      );
      return defaultValue;
    }
