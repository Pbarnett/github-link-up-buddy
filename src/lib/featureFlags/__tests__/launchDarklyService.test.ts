...
describe('LaunchDarklyService', () => {
  ...
  describe('Flag Evaluation', () => {
    ...
    it('should use fallback values when offline', async () => {
      ...
      const result = LaunchDarklyService.getVariation('personalization_greeting', true);
    ...
    it('should handle personalization flag correctly', () => {
      ...
      expect(result).toBe(true);
      expect(mockClient.variation).toHaveBeenCalledWith('personalization_greeting', false);
    });
    ...
    it('should handle opt-out banner flag correctly', () => {
      ...
      expect(result).toBe(true);
      expect(mockClient.variation).toHaveBeenCalledWith('show_opt_out_banner', false);
    });
  });
  ...
  describe('Developer Overrides', () => {
    ...
    it('should get variation with override', () => {
      ...
      const result = LaunchDarklyService.getVariationWithOverride('test_flag', false);
      
      expect(result).toBe(true);
      expect(localStorage.getItem).toHaveBeenCalledWith('launchDarkly_override_test_flag');
    });

    it('should clear developer override', () => {
      LaunchDarklyService.clearDeveloperOverride('test_flag');
      
      expect(localStorage.removeItem).toHaveBeenCalledWith('launchDarkly_override_test_flag');
    });
