...
export const DUFFEL_ERROR_MESSAGES: Record<string, string> = {
  ...
  [DuffelErrorType.OFFER_EXPIRED]: 'This flight is no longer available. Please search again for current options.',
  'offer_expired': 'This flight offer has expired. Please search again for current availability.',
  'offer_not_found': 'The selected flight is no longer available. Please choose a different option.',
  'seats_not_available': 'The requested seats are no longer available. Please select different seats.',
  
  // Validation errors
  [DuffelErrorType.VALIDATION_ERROR]: 'Please check your travel details and try again.',
  'invalid_passenger_details': 'Please verify all passenger information is correct and complete.',
  'invalid_travel_date': 'Please check your travel dates and ensure they are valid.',
  'missing_required_field': 'Please complete all required information to proceed.',
  
  // Payment errors
  [DuffelErrorType.PAYMENT_REQUIRED]: 'Payment is required to complete this booking.',
  [DuffelErrorType.INSUFFICIENT_FUNDS]: 'Payment was declined. Please try a different payment method.',
  [DuffelErrorType.PAYMENT_FAILED]: 'Payment could not be processed. Please check your payment details and try again.',
  'card_declined': 'Your card was declined. Please try a different payment method.',
  'payment_timeout': 'Payment processing timed out. Please try again.',
  
  // Document requirements
  [DuffelErrorType.IDENTITY_DOCUMENTS_REQUIRED]: 'Passport information is required for this international route.',
  'passport_required': 'A valid passport is required for this international flight.',
  'passport_expired': 'The passport provided has expired. Please update with current passport information.',
  'visa_required': 'A visa may be required for this destination. Please verify travel requirements.',
  
  // Pricing and schedule
  [DuffelErrorType.PRICE_CHANGED]: 'The price has changed since you started booking. Please review the new total.',
  [DuffelErrorType.SCHEDULE_CHANGED]: 'The flight schedule has changed since booking. Please review the updated itinerary.',
  'fare_no_longer_available': 'This fare is no longer available. Please select a different option.',
  
  // System errors
  [DuffelErrorType.RATE_LIMIT_EXCEEDED]: 'Too many requests. Please wait a moment and try again.',
  [DuffelErrorType.UNAUTHORIZED]: 'Authentication failed. Please contact support.',
  [DuffelErrorType.FORBIDDEN]: 'This action is not permitted. Please contact support.',
  [DuffelErrorType.INTERNAL_ERROR]: 'A system error occurred. Please try again or contact support.',
  [DuffelErrorType.SERVICE_UNAVAILABLE]: 'The booking service is temporarily unavailable. Please try again in a few minutes.',
  
  // Booking management
  [DuffelErrorType.BOOKING_NOT_FOUND]: 'Booking not found. Please check your booking reference.',
  'booking_already_cancelled': 'This booking has already been cancelled.',
  'booking_cannot_be_cancelled': 'This booking cannot be cancelled. Please contact the airline directly.',
 ...
 */
export function parseDuffelError(error: any): {
  type: string;
  message: string;
  userMessage: string;
  retryable: boolean;
  ...
  const message = originalError?.detail || originalError?.title || error?.message || 'Unknown error occurred';
 ...
 */
export function throwDuffelError(error: any, statusCode?: number): never {
