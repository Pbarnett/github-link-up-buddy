...
import { , IS_MOCK_MODE, MockKMSClient, MockSecretsManagerClient, MockS3Client, MockDynamoDBClient, MockSTSClient, MockCloudWatchClient } from '../aws-sdk-browser-compat';
  IS_MOCK_MODE,
  MockKMSClient,
