...
import logger from '@/lib/logger'; } from '@/components/trip/DuffelErrorHandler';
...
export const useDuffelPayment = (): UseDuffelPaymentReturn => {
  ...
  const [paymentIntent, setPaymentIntent] =
    useState<DuffelPaymentIntent | null>(null);
  ...
  const createPaymentIntent = useCallback(
    async (
      ...
      try {
        logger.info(
          '[DUFFEL-PAYMENT] Creating payment intent for Duffel booking:',
          {
