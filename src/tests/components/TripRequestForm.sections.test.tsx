...
describe('TripRequestForm Sections Tests', () => {
  ...
  describe('DateRangeSection', () => {
    ...
    describe('User Interactions', () => {
      ...
      it('should handle keyboard navigation', async () => {
        ...
        const dateButtons = screen.getAllByRole('button');
        if (dateButtons.length > 0) {
          // Focus first date button using user-event
          await user.click(dateButtons[0]);
          // Just verify that buttons are focusable and can be tabbed between
          await user.tab();
  ...
  describe('DestinationSection', () => {
    ...
    it('should handle destination selection', async () => {
      ...
      // Test that destination input exists and can be typed in
      if (inputs.length > 0) {
        await user.type(inputs[0], 'New York');
        // Component should accept input without errors
  ...
  describe('BudgetSection', () => {
    ...
    describe('User Interactions', () => {
      it('should handle valid budget input', async () => {
        ...
        // Verify input accepts typing without errors
      ...
      it('should handle keyboard navigation and focus', async () => {
        ...
        const budgetInput = screen.getByRole('spinbutton');
        await user.click(budgetInput);
        // Verify input can receive focus and keyboard input
        expect(budgetInput).toBeInTheDocument();
  ...
  describe('FilterTogglesSection', () => {
    describe('Rendering', () => {
      ...
      it('should display icons for each toggle option', () => {
        ...
        // Check for icons by their CSS classes (Lucide icons)
    ...
    describe('User Interactions', () => {
      ...
      it('should handle keyboard navigation between toggles', async () => {
        ...
        if (switches.length >= 2) {
          ...
          // Test that tab navigation works without errors
          await user.tab();
          // Just verify switches exist and navigation doesn't throw
    ...
    describe('Accessibility', () => {
      ...
      it('should associate labels with switches correctly', () => {
        ...
        switches.forEach(switchElement => {
          ...
          if (id) {
            // Look for a label element that has for=id
