...
import AuthGuard from '@/components/AuthGuard'; } from '@/hooks/usePaymentMethods';
  ...
  const handleSetDefault = async (paymentMethod: PaymentMethod) => {
    ...
    try {
      ...
      toast({
        ...
        description:
          'Your default payment method has been updated in both our system and Stripe.',
      });
  ...
  const handleDeleteCard = async (paymentMethod: PaymentMethod) => {
    ...
    try {
      ...
      toast({
        ...
        description:
          'Your payment method has been removed from both our system and Stripe.',
      });
            ...
            {!stripeKey && (
              <div className="bg-yellow-100 border-l-4 border-yellow-500 p-4">
                <p className="text-yellow-700">
                  ...
                  <code>VITE_STRIPE_PUBLIC_KEY</code> in your
                  <code>.env</code>.
                </p>
              </div>
            )}
