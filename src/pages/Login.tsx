...
const Login = () => {
    ...
    const initializeAuth = async () => {
      try {
        ...
        const hashParams = new URLSearchParams(
          /* eslint-disable-next-line no-undef */ /* eslint-disable-next-line no-undef */ /* eslint-disable-next-line no-undef */ window.location.hash.substring(
            1
          )
        );
  ...
  // ARCHIVED: Magic Link Login functionality removed for Google-only MVP
  // Magic link authentication can be restored by implementing the handleEmailLogin function
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      // console.log("Initiating Google login from:", /* eslint-disable-next-line no-undef */ /* eslint-disable-next-line no-undef */ /* eslint-disable-next-line no-undef */ window.location.origin); // Removed
      // console.log("Redirect URL:", /* eslint-disable-next-line no-undef */ /* eslint-disable-next-line no-undef */ /* eslint-disable-next-line no-undef */ window.location.origin + '/dashboard'); // Removed
      ...
      //   options: { // Removed
      //     redirectTo: /* eslint-disable-next-line no-undef */ /* eslint-disable-next-line no-undef */ /* eslint-disable-next-line no-undef */ window.location.origin + '/dashboard', // Removed
