        ...
        <CardContent className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <Alert variant={searchSuccess ? "default" : "destructive"}>
                ...
                <AlertDescription>
                  {searchSuccess ? (
                    <>
                      ✅ Search successful! Found {searchResponse.offersFound} offers, 
                      inserted {searchResponse.inserted} into database.
                    </>
                  ) : (
                    <>
                  ...
                  <Card key={offer.id} className="p-4">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                      <div>
                        ...
                        <p>{offer.airline_code} {offer.flight_number}</p>
                      </div>
                      <div>
                        <span className="font-medium">Route:</span>
                        <p>{offer.origin_airport} → {offer.destination_airport}</p>
                      </div>
                      <div>
          ...
          {offers.length > 0 && (
            <div className="space-y-4">
              ...
              <p className="text-gray-600">
                Click "Test Booking" to validate the booking component with the first offer:
              </p>
          ...
          <div className="border-t pt-6">
            ...
            <div className="text-sm text-gray-600 space-y-2">
              <p>
                <strong>Step 1:</strong> Enter a valid trip request ID from your database
              </p>
              <p>
                <strong>Step 2:</strong> Click "Search Duffel Flights" to test the search integration
              </p>
              <p>
                <strong>Step 3:</strong> Review the search results and offers returned
              </p>
              <p>
                <strong>Step 4:</strong> Test the booking flow with the first offer (uses test data)
              </p>
              <p>
                <strong>Note:</strong> This page is for development testing only and should not be accessible in production.
              </p>
            </div>
          </div>
        </CardContent>
