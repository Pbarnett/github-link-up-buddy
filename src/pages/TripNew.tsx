        ...
        <div className="w-full max-w-screen-lg mx-auto" style={{ width: 'clamp(640px, 80%, 1100px)' }}>
          ...
          <div className="mb-12">
            <div className="flex items-center justify-between mb-6">
              <button
                ...
                className="flex items-center gap-2 text-sm analyst-text-muted hover:text-accent-analyst transition-colors focus:outline-none focus:ring-2 focus:ring-accent-analyst focus:ring-offset-2 rounded-md p-1"
            ...
            <div className="text-center">
              <h1 className="text-h1 analyst-text-primary mb-3">
                Pick how we'll book for you
              </h1>
              <p className="text-lg analyst-text-muted mb-2">
                Choose your preferred booking approach
              </p>
              <p className="text-sm analyst-text-muted">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8" data-analytics="mode_choice">
            ...
            <ChoiceCard
              ...
              badges={[
                <TagChip key="realtime" icon={<Zap />} variant="primary">
                  Real-time prices
                </TagChip>,
                <TagChip key="compare" icon={<CheckCircle />} variant="primary">
                  Compare airlines
                </TagChip>,
                <TagChip key="immediate" icon={<Clock />} variant="primary">
                  Book immediately
                </TagChip>
              ]}
            ...
            <ChoiceCard
              ...
              badges={[
                <TagChip key="monitor" icon={<Plane />} variant="accent">
                  Monitor automatically
                </TagChip>,
                <TagChip key="smart" icon={<CheckCircle />} variant="accent">
                  Smart booking
                </TagChip>,
                <TagChip key="limits" icon={<DollarSign />} variant="accent">
                  Price limits
                </TagChip>
              ]}
              ...
              className="hover:border-teal-500 focus-within:ring-teal-500"
            />
          </div>

          {/* Trust Badge */}
          <div className="flex items-center justify-center gap-2 text-xs analyst-text-muted trust-badge">
