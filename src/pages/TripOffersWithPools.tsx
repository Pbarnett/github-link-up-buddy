...
import TripOfferDetailsCard from '@/components/trip/TripOfferDetailsCard'; } from '@/hooks/useTripOffers';
    ...
    <div className="min-h-screen flex flex-col items-center bg-gray-50 p-4">
      ...
      {isUsingFallback && (
        <Alert className="w-full max-w-4xl mt-4 mb-2">
          ...
          <AlertDescription>
            Using simplified view due to loading issues. All offers are shown in
            a single list.
          </AlertDescription>
        </Alert>
      )}
