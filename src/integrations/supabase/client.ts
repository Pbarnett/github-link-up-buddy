...
if (!SUPABASE_URL) {
  console.error("VITE_SUPABASE_URL is not set. Please check your .env file or environment variables.");
  throw new Error("VITE_SUPABASE_URL is not set. Please check your .env file or environment variables.");
}
if (!SUPABASE_PUBLISHABLE_KEY) {
  console.error("VITE_SUPABASE_ANON_KEY is not set. Please check your .env file or environment variables.");
