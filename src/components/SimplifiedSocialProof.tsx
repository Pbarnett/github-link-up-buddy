...
export const SimplifiedSocialProof: FC<SimplifiedSocialProofProps> = ({ 
  ...
  return (
    <div className={`social-proof-redesigned ${className}`}>
      <p>
        <strong>7,412 trips auto-booked</strong> in the last 30 days – average savings <strong>$186</strong>.
        <span className="live-indicator">●</span> {todayBookings} bookings today
      </p>
    </div>
  );
};
