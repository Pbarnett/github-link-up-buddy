        ...
        render={({ field }) => (
          <FormItem>
            <FormLabel className="text-sm font-medium text-gray-900">
              Other Departure Airport (IATA code)
            </FormLabel>
            <FormDescription className="text-sm text-gray-600">
              If you're not departing from NYC, enter another airport code
              (e.g., BOS, PHL).
            </FormDescription>
            <FormControl>
              <Input
