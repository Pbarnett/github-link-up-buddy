...
const SidebarMenuSubItem = ({ ref, ...props }: SidebarMenuSubItemProps) => <li ref={ref} {...props} />;
...
const SidebarMenuSubButton = ({ asChild = false, size = 'md', isActive, className, ref, ...props }: SidebarMenuSubButtonProps) => {
