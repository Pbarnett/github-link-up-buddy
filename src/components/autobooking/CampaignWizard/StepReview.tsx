      ...
      <CardContent className="space-y-6">
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
            ...
            <div className="space-y-2">
              ...
              <Badge variant="secondary">
                {criteriaData.tripType === 'round_trip'
                  ? 'Round Trip'
                  : 'One Way'}
              </Badge>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="font-medium text-green-600">
                ${criteriaData.maxPrice.toLocaleString()}
              </p>
            </div>
          </div>
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <div className="space-y-2">
              ...
              <p className="font-medium">
                {criteriaData.origin} → {criteriaData.destination}
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="font-medium">
                {formatDate(criteriaData.departureStart)} -{' '}
                {formatDate(criteriaData.departureEnd)}
              </p>
            </div>
          </div>

          {criteriaData.tripType === 'round_trip' &&
            (criteriaData.returnStart || criteriaData.returnEnd) && (
              <div className="grid gap-4 md:grid-cols-2">
                <div className="space-y-2">
                  <p className="text-sm font-medium text-gray-500">
                    Return Window
                  ...
                  <p className="font-medium">
                    {formatDate(criteriaData.returnStart || '')} -{' '}
                    {formatDate(criteriaData.returnEnd || '')}
                  </p>
                </div>
          ...
          <div className="grid gap-4 md:grid-cols-3">
            <div className="space-y-2">
              ...
              <Badge variant="outline">
                {getCabinClassName(criteriaData.cabinClass)}
              </Badge>
            </div>
                ...
                <div className="space-y-2">
                  ...
                  {travelerData.passportExpiry && (
                    <p className="text-sm text-gray-500">
                      Expires: {formatDate(travelerData.passportExpiry)}
                    </p>
                  )}
                </div>
              )}
              ...
              <div className="grid gap-4 md:grid-cols-2">
                {travelerData.frequentFlyerNumber && (
                  <div className="space-y-2">
                    ...
                    <p className="font-medium">
                      {travelerData.frequentFlyerAirline}:{' '}
                      {travelerData.frequentFlyerNumber}
                    </p>
                  </div>
                )}
        ...
        <div className="bg-blue-50 p-4 rounded-lg">
          ...
          <ul className="text-sm text-gray-600 space-y-1">
            ...
            <li>
              • When we find a deal within your budget, we'll automatically book
              it
            </li>
            <li>
              • You'll receive instant notifications about bookings and status
              updates
            </li>
            <li>
              • You can pause or modify your campaign anytime from the dashboard
            </li>
          </ul>
        </div>
