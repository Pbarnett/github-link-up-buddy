...
export function SimpleProfileStatus({
  ...
  const getStatusMessage = (score: number) => {
    ...
    if (score >= 80)
      return {
        message: 'Almost complete - just a few more details',
        variant: 'default' as const,
      };
    if (score >= 60)
      return {
        message: 'Good progress! Keep adding information',
        variant: 'default' as const,
      };
    return {
      message: "Let's complete your profile for the best experience",
    ...
    <Card className={className}>
      <CardHeader className="pb-4">
        <div className="flex items-center justify-between">
          ...
          <Badge
            variant={overall >= 80 ? 'default' : 'secondary'}
                ...
                {onActionClick && (
                  ...
                  >
                    {getActionIcon(nextStep.action) &&
                      createElement(getActionIcon(nextStep.action), {
        ...
        <div className="flex items-center justify-between">
          ...
          {overall < 100 && (
            <Button
              ...
              variant="outline"
              onClick={() =>
                onActionClick?.(nextStep?.action || 'complete_profile')
              }
            >
