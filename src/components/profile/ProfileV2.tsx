        ...
        <CardHeader className="bg-gradient-to-r from-blue-50 to-indigo-50 border-b">
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription>
                Manage your personal information and family traveler profiles
        ...
        <Card className="bg-gradient-to-r from-orange-50 to-yellow-50 border-orange-200">
          <CardHeader>
            ...
            <CardDescription className="text-orange-700">
              Complete these sections to unlock all features and get the best
              travel experience.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="grid gap-3">
              {completenessData.recommendations
                ...
                .map((rec, index) => (
                  <div
                    key={index}
                    className="flex items-start gap-3 p-3 bg-white/50 rounded-lg border border-orange-200"
                  >
