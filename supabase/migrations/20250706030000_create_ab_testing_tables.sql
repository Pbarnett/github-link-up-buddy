...
CREATE TABLE IF NOT EXISTS ab_test_events (
    ...
    INDEX idx_ab_test_events_test_variant (ab_test_id, variant_id),
    INDEX idx_ab_test_events_type_date (event_type, created_at),
    INDEX idx_ab_test_events_assignment (assignment_id)
);
...
SELECT 
    ...
    true,
    0.50,
    dynamic_forms.configuration
FROM ab_tests
JOIN dynamic_forms ON ab_tests.form_id = dynamic_forms.id
