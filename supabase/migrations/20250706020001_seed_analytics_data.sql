...
INSERT INTO form_analytics_events (
  ...
  ('Parker Flight Search', 'view', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_7)', NOW() - INTERVAL '2 hours'),
  ('Parker Flight Search', 'view', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64)', NOW() - INTERVAL '1.5 hours'),
  ('Parker Flight Search', 'submit', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_7)', NOW() - INTERVAL '1 hour'),
  ('Contact Form', 'view', 'Mozilla/5.0 (iPhone; CPU iPhone OS 15_0 like Mac OS X)', NOW() - INTERVAL '45 minutes'),
  ('Newsletter Signup', 'view', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_7)', NOW() - INTERVAL '30 minutes'),
  ('Newsletter Signup', 'submit', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_7)', NOW() - INTERVAL '25 minutes'),
  ('Trip Preferences', 'view', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64)', NOW() - INTERVAL '15 minutes'),
  ('Parker Flight Search', 'view', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_7)', NOW() - INTERVAL '10 minutes');
