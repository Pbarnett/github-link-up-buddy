...
-- This migration addresses the constraints that prevent the test user creation
...
-- Create a trigger to automatically update last_login_at on profile updates
...
CREATE TRIGGER profiles_update_last_login
