...
DROP POLICY IF EXISTS "Users can view their own auto booking requests" ON public.auto_booking_requests;
...
DROP POLICY IF EXISTS "Users can create their own auto booking requests" ON public.auto_booking_requests;
...
DROP POLICY IF EXISTS "Users can update their own auto booking requests" ON public.auto_booking_requests;
...
DROP POLICY IF EXISTS "Users can delete their own auto booking requests" ON public.auto_booking_requests;
