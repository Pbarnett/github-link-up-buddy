...
curl -X GET "${VITE_SUPABASE_URL:-https://your-project-id.supabase.co}/functions/v1/secure-traveler-profiles" \
  -H "Authorization: Bearer ${VITE_SUPABASE_ANON_KEY:-your_anon_key_here}" \
  -H "apikey: ${VITE_SUPABASE_ANON_KEY:-your_anon_key_here}" \
